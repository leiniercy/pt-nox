...
const Seccion7 = ({ className }) => {
  ...
  return (
    <>
      <main
        className={`w-full flex items-center justify-center py-6 px-4 md:p-24 + ${className}`}
      >
        <section
          data-aos='fade-up'
          data-aos-easing='linear'
          data-aos-duration='1000'
          className='w-full lg:w-[85%] flex flex-col lg:flex-row items-center justify-center border rounded-[20px] py-6 md:py-12 md:pl-8 lg:py-16 lg:pl-16 border-[#475569]'
        >
